...
import json
import os
from flask import Flask, render_template, request, jsonify, session , redirect ,flash , render_template_string , url_for
from dotenv import load_dotenv # Import to load environment variables
from flask_cors import CORS
from db import db_session , QuestionsAndAnswers
